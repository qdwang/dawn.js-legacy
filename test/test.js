...
(function() {
  var BNF, G, IR, LR1, Lexer, SymbolTable, Zipper, ast, bnf, i, len, log, lp, mm, plain_tree, prepare_syntax, sampleA, sampleAST, sampleB, sampleC, sampleD, sampleLex, sample_obj, state, stringEqual, table, tables, test_script, test_syntax, ulti, zipperNodeTest;
