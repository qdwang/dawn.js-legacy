...
(function() {
  var BNF, BNFGrammar, G, IR, LR1, LexParser, Lexer, MixMap, SymbolTable, SyntaxParser, SyntaxTable, Zipper, ast, bnf, cache_dir, dawnjs_dir, fs, home, i, len, log, lp, mm, plain_tree, prepare_syntax, sampleA, sampleAST, sampleB, sampleC, sampleD, sampleLex, sample_ast_file, sample_obj, state, stringEqual, table, tables, test_script, test_syntax, ulti, zipperNodeTest;
