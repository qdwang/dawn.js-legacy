...
(function() {
  var BNF, BNFGrammar, Flow, G, IR, LR1, LexParser, Lexer, MixMap, SymbolTable, SyntaxParser, SyntaxTable, Zipper, args, ast, bnf, cache_dir, cb, dawnjs_dir, flow, fs, grammar, home, i, len, lex_syntax, localService, log, lp, lr1_parser_ast, lr1_parser_lex, lr1_parser_mm, ls, ls_ast, ls_lex, ls_mm, mm, parser, plain_tree, prepare_syntax, sampleA, sampleAST, sampleB, sampleC, sampleD, sampleLex, sample_ast_file, sample_obj, script, state, stringEqual, table, tables, test_script, test_syntax, ulti, zipperNodeTest;
